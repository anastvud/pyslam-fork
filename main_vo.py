        ...
        if img is not None:
            ...
            if hasattr(vo, "poses") and len(vo.poses) > 0:
                ...
                if pose is not None:
                    ...
                    with open("/home/nastia/datasets/rosbags/sim_longer/finetuned_predicted_tum.txt", "a") as f:
            ...
            #         # with open("data/sim_rotated_imu/predicted_tum.txt", "a") as f:
            #         with open("/home/nastia/datasets/kitti/sequences/01/superpoint_predicted_t_matrix.txt", "a") as f:
