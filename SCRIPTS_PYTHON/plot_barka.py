...
gt_path = "/home/nastia/datasets/rosbags/barka/20251130_3//gt_tum.txt"
pred_path = "/home/nastia/datasets/rosbags/barka/20251130_3/aligned_superpoint.txt"
rotated_path = "/home/nastia/datasets/rosbags/barka/20251130_3/aligned_orb.txt"
path4_path = "/home/nastia/datasets/rosbags/barka/20251130_3/aligned_finetuned.txt"
...
gtx = gt["z"].to_numpy() * -1.0
gty = gt["x"].to_numpy()
gtz = gt["y"].to_numpy() * -1.0
...
ax2.set_ylabel('y')
ax2.set_zlabel('z')
ax2.set_title('3D BARKA (Different View)')
